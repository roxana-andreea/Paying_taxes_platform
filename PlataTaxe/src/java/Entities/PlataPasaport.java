 ...
 */
@Entity
@Table(name = "PlataPasaport")
public class PlataPasaport implements Serializable {
    ...
    @Column(name="culoare_ochi")
    private String culoare_ochi;
    
    @Column(name="tip_pasaport")
    private String tip_pasaport;
    ...
    public String getTip_pasaport() {
        return tip_pasaport;
    }

    public void setTip_pasaport(String tip_pasaport) {
        this.tip_pasaport = tip_pasaport;
    }
    ...
    public boolean equals(Object object) {
        ...
        PlataPasaport other = (PlataPasaport) object;
    ...
    public String toString() {
        return "Entities.PlataPasaport[ id=" + id + " ]";
    }
